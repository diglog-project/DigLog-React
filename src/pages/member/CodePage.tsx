...
function CodePage() {
    ...
    return (
        <BasicLayout center={true}>
            <div className='w-full max-w-[calc(420px)] flex flex-col justify-center items-center gap-y-2 mb-8'>
                <div className='flex flex-col gap-y-1 mb-4 text-center font-normal text-gray-600'>
                    <p>
                        <span className='font-black text-gray-900'>{email}</span> 로 보내진
                    </p>
                ...
                <div className='mt-4'>유효시간 : {formatTimer(timer)}</div>
            </div>
