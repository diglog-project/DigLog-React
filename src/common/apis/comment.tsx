...
export const saveComment = async (commentRequest: CommentRequest) => await axiosApi.post('/comment', commentRequest);
...
export const deleteComment = async (id: string) => await axiosApi.patch(`/comment/delete/${id}`);
