...
export const createPost = async (postRequest: PostRequest) => await axiosApi.post('/post', postRequest);
...
export const deletePost = async (id: string) => await axiosApi.patch(`/post/delete/${id}`);

export const getPost = async (id: string) => await axiosApi.get(`/post/${id}`);
...
export const getPostViewCount = async (id: string) => await axiosApi.get(`/post/view/${id}`);
