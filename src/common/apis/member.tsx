...
export const handleKakaoLogin = () => (location.href = `${import.meta.env.VITE_SERVER_URL}/oauth2/authorization/kakao`);

export const getProfile = async () => await axiosApi.get('/member/profile');

export const getProfileByUsername = async (username: string) => await axiosApi.get(`/member/profile/${username}`);
