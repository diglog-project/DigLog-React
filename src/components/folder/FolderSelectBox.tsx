...
function FolderSelectBox({
    ...
    return (
        <div
            ...
            } text-gray-700 items-center my-2 text-sm font-normal`}
        >
            <button
            ...
            <div
                className={`${
                    folderOpen ? '' : 'hidden'
                } h-72 min-h-16 overflow-y-scroll absolute z-50 w-full top-12 left-0 bg-white divide-y divide-gray-300 rounded-lg shadow-sm`}
            >
                {folders.map(folder => (
                    <FolderSelectCard
                        key={folder.id}
